...
<TH style='width:96%'><FONT size='+2'>Filmes no DB</FONT></TH>
</TR></TABLE>
<TABLE style='width:100%'>
<TR>
<TH style='width:04%'><em>FILME</em></TH>
<TH style='width:48%'><FONT size='+1'><em>EM PORTUGUES</em></FONT></TH>
<TH style='width:48%'><FONT size='+1'><em>EM INGLES</em></FONT></TH>
</TR>
<%
	...
	for(int i = 0; i < filmes.size(); i++) {
        ...
        out.println("</TABLE>" +
  	    ...
  	    out.println("<TR>" +
  					...
  					"<TH ><A HREF='detalha-filme-admin?idfilme=" + filmes.get(i).getIdFilme() + "'>" +
